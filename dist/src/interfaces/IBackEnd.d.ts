...
import { IPublishingStrategy, ITextToAudioStrategy, ITable, IList, ISortedSet, ISet, IServiceRegistry } from "./";
...
export interface IBackEnd {
    ...
    getAudioGeneration(key: string): ITextToAudioStrategy<BaseAudioGenerationConfig> | undefined;
    getLogStrategy(key: string): LogStrategy;
    addPublishing(key: string, strategy: IPublishingStrategy): void;
    addAudioGeneration(key: string, strategy: ITextToAudioStrategy<BaseAudioGenerationConfig>): void;
}
